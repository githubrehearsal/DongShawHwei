...
<body>
                                ...
                                <div class="navbar-collapse collapse clearfix">
									<ul class="navigation clearfix">
										...
										<li class="dropdown"><a><?php echo _('language'); ?></a>
											<ul>
												<li>
													<a href="ancient.php?lang=tw">繁體中文</a>
												</li>
												<li>
													<a href="ancient.php?lang=en">English</a>
												</li>
											</ul>
										</li>
									</ul>
    ...
    <!-- Header Section End -->
    <!-- Breadcrumbs Start -->
    <div class="pages-header bg-color-2" style="background-image: url(assets/img/portfolio/ancient/top-banner.jpg);">
        <div class="container">
            <div class="row text-center">
                <div class="col-xs-12">
                    <div class="page-title ptb-110">
                        <div class="page-title-area">
                            <h1 class="title-l mb-15">董小蕙的倣古系列</h1>
                            <h4 class="title-m mb-5">Imitate the Ancient Painting
